        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://wa.me/3548575955" target="_blank" rel="noopener noreferrer" className="bg-white p-1.5 rounded-xl shadow-lg hover:scale-105 transition-transform hidden sm:block">
                <Image
                  src="/whatsapp-qr.png"
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto pt-8 border-t border-slate-800/50 lg:border-t-0 lg:pt-0">
              ...
              <div className="flex flex-wrap items-center gap-2 lg:justify-end">
                {/* Stripe */}
                <div className="bg-white px-2 py-1.5 rounded-sm shadow-sm border border-slate-200 flex items-center justify-center h-[40px] w-[68px] hover:scale-105 transition-transform">
                  <img src="/stripe-logo.png" alt="Stripe" className="w-[48px] h-auto object-contain" />
                </div>

                {/* Visa */}
                <div className="bg-white px-2 py-1.5 rounded-sm shadow-sm border border-slate-200 flex items-center justify-center h-[40px] w-[68px] hover:scale-105 transition-transform">
                  <svg viewBox="0 0 50 16" xmlns="http://www.w3.org/2000/svg" className="w-[48px] h-auto fill-[#1434CB]">
                ...
                {/* MasterCard */}
                <div className="bg-white px-2 py-1.5 rounded-sm shadow-sm border border-slate-200 flex items-center justify-center h-[40px] w-[68px] hover:scale-105 transition-transform relative overflow-hidden">
                  <svg viewBox="0 0 60 36" xmlns="http://www.w3.org/2000/svg" className="w-[50px] h-auto p-0.5">
                    ...
                    <text x="30" y="21.5" fontFamily="Arial, Helvetica, sans-serif" fontStyle="italic" fontWeight="900" fontSize="10" fill="white" textAnchor="middle" style={{textShadow: "0px 1px 2px rgba(0,0,0,0.5)"}}>MasterCard</text>
                  </svg>
                </div>

                <div className="bg-white px-2 py-1.5 rounded-sm shadow-sm border border-slate-200 flex items-center justify-center h-[40px] w-[100px] hover:scale-105 transition-transform gap-1">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-[20px] w-auto">
                  ...
                  <div className="font-bold text-[17px] tracking-tight leading-none italic flex" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
