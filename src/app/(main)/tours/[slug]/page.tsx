        ...
        <div className="min-h-screen bg-white dark:bg-slate-900">
            ...
            <div className="relative h-[60vh] min-h-[400px]">
                ...
                <div className="absolute inset-0 flex items-end">
                    <div className="max-w-7xl mx-auto w-full px-4 pb-12 lg:pb-20">
                        <div className="max-w-3xl">
                            {tour.badge && (
                                <span className="inline-block px-3 py-1 bg-primary text-black text-sm font-bold rounded-full mb-4">
                                    {tour.badge.text}
                                </span>
                            )}
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="font-bold text-slate-900 dark:text-white">{tour.distance || 'Variable'}</span>
                            </div>
                            <div className="flex flex-col gap-1">
                                <span className="flex items-center gap-2 text-slate-500 dark:text-slate-400 text-sm">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="font-bold text-slate-900 dark:text-white">{tour.category.replace('_', ' ')}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
                                <p>
                                    Experience the magic of Iceland with our {tour.name}. This comprehensive tour takes you through
                                    some of the most spectacular landscapes the country has to offer. Traveling in comfort and style,
                                    you will witness breathtaking waterfalls, geothermal wonders, and historic sites.
                                </p>
                                <p className="mt-4">
                                    Our professional driver-guides possess extensive local knowledge and will ensure your journey
                                    is safe, informative, and unforgettable. Whether you are looking for adventure or relaxation,
                                    this tour offers the perfect blend of both.
                                </p>
                            </div>
                        </div>
