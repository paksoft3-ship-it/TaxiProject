...
const reviews = [
  {
    ...
    content: 'Our driver Jónas was fantastic! He knew all the best spots and even took us to a hidden waterfall that wasn\'t on the itinerary. The vehicle was spotless and comfortable. Highly recommend for anyone visiting Iceland!',
    helpful: 24,
    verified: true,
  },
  {
